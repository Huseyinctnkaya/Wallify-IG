/*
  ...
  - You are about to drop the column `desktopColumns` on the `Settings` table. All the data in the column will be lost.
  - You are about to drop the column `mobileColumns` on the `Settings` table. All the data in the column will be lost.
...
INSERT INTO "new_Settings" ("arrowBackgroundColor", "arrowColor", "borderRadius", "cardBadgeBackgroundColor", "cardBadgeIconColor", "cardUserNameColor", "feedType", "id", "onClick", "playVideoOnHover", "postSpacing", "shop", "showArrows", "showAttachedProducts", "showAuthorProfile", "showPinnedReels", "showThumbnail", "showViewsCount", "subheading", "subheadingColor", "title", "titleColor", "updatedAt") SELECT "arrowBackgroundColor", "arrowColor", "borderRadius", "cardBadgeBackgroundColor", "cardBadgeIconColor", "cardUserNameColor", "feedType", "id", "onClick", "playVideoOnHover", "postSpacing", "shop", "showArrows", "showAttachedProducts", "showAuthorProfile", "showPinnedReels", "showThumbnail", "showViewsCount", "subheading", "subheadingColor", "title", "titleColor", "updatedAt" FROM "Settings";
DROP TABLE "Settings";

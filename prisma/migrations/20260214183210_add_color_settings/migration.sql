...
INSERT INTO "new_Settings" ("borderRadius", "desktopColumns", "feedType", "id", "mobileColumns", "onClick", "playVideoOnHover", "postSpacing", "shop", "showArrows", "showAttachedProducts", "showAuthorProfile", "showPinnedReels", "showThumbnail", "showViewsCount", "subheading", "title", "updatedAt") SELECT "borderRadius", "desktopColumns", "feedType", "id", "mobileColumns", "onClick", "playVideoOnHover", "postSpacing", "shop", "showArrows", "showAttachedProducts", "showAuthorProfile", "showPinnedReels", "showThumbnail", "showViewsCount", "subheading", "title", "updatedAt" FROM "Settings";
DROP TABLE "Settings";
